...
Future<Stream<List<VehiculoModelo>>> obtenerModelosVehiculoSearch(
    String texto) async {
  // Uri uri = Helper.getUriLfr('api/producto');

  final String url =
      '${GlobalConfiguration().getString('api_base_url_wash')}modelos/getById/' +
          texto; /*cambiar por id del cliente*/
