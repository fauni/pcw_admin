...
Future<Stream<List<VehiculoA>>> obtenerVehiculoByIdClientePlaca(
    String id, String placa) async {
  // Uri uri = Helper.getUriLfr('api/producto');

  final String url =
      '${GlobalConfiguration().getString('api_base_url_wash')}vehiculos/obtenerPorClientePlaca/' +
          id +
          "/" +
          placa; /*cambiar por id del cliente*/
...
//obtencion de vehiculos por placa
Future<Stream<List<VehiculoA>>> obtenerVehiculosByPlaca(String placa) async {
  // Uri uri = Helper.getUriLfr('api/producto');

  final String url =
      '${GlobalConfiguration().getString('api_base_url_wash')}vehiculos/obtenerPorPlacas/' +
          placa;
